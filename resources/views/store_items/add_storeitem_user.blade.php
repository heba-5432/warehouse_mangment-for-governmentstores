						...
						<div class="card  box-shadow-0">
							<div class="card-header">
								<h4 class="card-title mb-1">
									<p class="mb-2">{{trans('transfile.stores_system')}}/صرف العهد </p>
...
<form class="form-horizontal"  method="POST" action=" {{route('items_users_store.store')  }}"  enctype="multipart/form-data">
								@csrf
								@method('POST')
...
<select class=" select2 col-lg-10 mg-t-20 mg-lg-t-0 " name="users_name[]"  multiple="multiple">
...
<input style ="margin:10px; padding:10px;" type="number" id ="input1" class=" col-lg-5 mg-t-20 mg-lg-t-0" id="inputPassword3" name ="items_number" placeholder="العدد المطلوب"  value="1" min="0" required>
...
<input style ="margin:8px; padding:10px;" type="number" id= "input2"class=" col-lg-4 mg-t-20 mg-lg-t-0" id="inputPassword3" name ="returned_number" placeholder=" العدد تم استرجاعه"  value="0" min="0" required>
...
<label style="color:red">العدد الحالى الذي لم يتم استرجاعه للعهدة    <input type="number" value="0"  style="color:red" id="result" name="number_current" > </label>
...
<!-- col-4 -select start--->
 ...
 <a href="{{ route('store_items.single_export',$store_items->storeitid) }}" class="btn btn-primary-gradient mt-2 mb-2 pb-2"  name="export_singleitems" value="1">export to excel</a>
  ...
  <th width="1%"><input type="checkbox" id="select-all" onclick="toggleSelectAll(this)">all</th>
                                            <th width="1%">no.&nbsp;&nbsp;</th>
                                                ...
                                                <th class="border-bottom-0"  width="1%">  اسم صاحب العهدة &nbsp;</th>
                                                 <th class="border-bottom-0"  width="1%">اسماء اصحاب العهدة التضامنية &nbsp;</th>
                                                <th class="border-bottom-0"  width="1%"> الادارة  &nbsp;</th>
                                               <th>نوع العهدة</th>
  <th>العدد المستعار الاصلى</th>
...
<th>العدد المنقول</th>
										...
										<tbody>
@if(!empty($users_items))
@foreach($users_items as $ur_item)
...
<td>{{ $single_status->value('ar_titles2')}}</td>
...
<option value="{{$users_items->value('item_store_id') }}"




>{{$users_items->value('title_arai')}}</option>
...
<!---/////////--لنقل العهده المستعمل-start----->
<div style ="border:lightgray solid 1px;width:100%;padding:10px;">
<label style ="margin:2px; padding:3px;" style="">العدد المسترجع</label>
 <input  style ="width:120px;"  onchange="calculateSum" type="number" class="col-lg-5 mg-t-20 mg-lg-t-0" id="num2" name ="returned_number" placeholder=" العدد الكلى بالقطعه" value="{{ old('quantity') }}" min="1" required>

<!-- col-4 -select start--->


<label style ="margin:2px; padding:3px;">السعرالتقديري للقطعه</label>
<input input type="number"  onchange="calculateSum" id="num1" name="used_price" min="0" step="0.01" placeholder="0.00"  value="{{ old('new_price') }}" style ="width:120px;">
...
<div class="modal-content modal-content-demo">
		...
		<!-- End Basic modal - delete-alert end---->
                                              ...
                                              <!--  <td> <a href="{{ route('store_items.add_user',$ur_item->id) }}"><button class="btn ripple btn-primary" type="button">اضافه عهدة للمستخدم</button></a></td>
