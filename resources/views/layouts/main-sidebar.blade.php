...
@endphp
				...
				<ul class="side-menu">
					<li class="side-item side-item-category">Main(roll payments)</li>
<!---- user personal info start------>
                    ...
                    <ul class="side-menu">
					<li class="side-item side-item-category">{{trans('معلومات عن الصفحة الشخصية')}}</li>
                    <li class="slide">
						...
						<ul class="slide-menu">
                             ...
                             <li><a class="slide-item" href="{{ url('/' . $page='store_items/store_singel_user_loans') }}"> العهدة الشخصيه من المخزن</a></li>
...
<ul class="side-menu">
					...
					<li class="side-item side-item-category">{{trans('transfile.stores_system')}}</li>

<!-- add users start store system---->
   <li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">{{"معلومات عن الموظفين"}}</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
 ...
 <!--- add users end- store system-->

<!-- price list info store system
   <li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">{{"القيمه السعريه للمنتجات "}}</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
                         <li><a class="slide-item" href="{{ url('/' . $page='store_pricelist') }}">  القيمه السعريه للمنتجات بمخزن العناصر الجديده</a></li>

							<li><a class="slide-item" href="{{ url('/' . $page='store_pricelist/loaned') }}">  القيمه السعريه للمنتجات  للعهد الشخصيه الحاليه</a></li>


						</ul>
					</li>
 price list info end- store system-->



                    <li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">{{trans('التحكم فى العناصر بالمخزن')}}</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">

                      <li><a class="slide-item" href="{{ url('/' . $page='store_items/show') }}">  {{trans('البحث عن المنتجات')}}</a></li>
 <li><a class="slide-item" href="{{ url('/' . $page='store_items/filter_users_show') }}">  {{trans(key: 'البحث عن مستعير ')}}</a></li>

                        <li><a class="slide-item" href="{{ url('/' . $page='items_store') }}">  {{trans('اضافه جديد')}}</a></li>

 <li><a class="slide-item" href="{{ url('/' . $page='items_users_store') }}">  {{trans('العهدة الشخصيه المستعارة')}}</a></li>

                        <li><a class="slide-item" href="{{ url('/' . $page='items_store_used') }}">  {{trans(' العناصر المستعملةوصالحه لاستخدام')}}</a></li>

 <li><a class="slide-item" href="{{ url('/' . $page='corrupted_storage_item') }}">  {{trans('عناصر مخزن الكهنه')}}</a></li>


                        <li><a class="slide-item" href="{{ url('/' . $page='add_poor_storage_item') }}">  {{trans('عناصر تالف من سوء التخزين')}}</a></li>
<li><a class="slide-item" href="{{ url('/' . $page='code_list_items') }}">  {{trans('كود الموحد لاصناف')}}</a></li>

                        <li><a class="slide-item" href="{{ url('/' . $page='items_store_catogery') }}">  {{trans('التصنيف')}}</a></li>
                        <li><a class="slide-item" href="{{ url('/' . $page='items_store_status1') }}">   {{trans('الحاله(جديد مستعمل)')}}</a></li>
                        <li><a class="slide-item" href="{{ url('/' . $page='items_store_status2') }}">   {{trans('(دائم - مستهلك)الحاله')}}</a></li>
...
<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">{{trans('transfile.super_admin_control')}}</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">


                        <li><a class="slide-item" href="{{ url('/' . $page='catogery') }}">  {{trans('transfile.library_catogries')}}</a></li>
                        <li><a class="slide-item" href="{{ url('/' . $page='catogery2') }}">   {{trans('transfile.library_catogries2')}}</a></li>

                        <li><a class="slide-item" href="{{ url('/' . $page='keywords') }}">  {{trans('transfile.library_keywords')}}</a></li>
                        <li><a class="slide-item" href="{{ url('/' . $page='timeschdule') }}">  {{trans('transfile.time')}}</a></li>
...
<li class="slide">
                        ...
                        <li><a class="slide-item" href="{{ url('/' . $page='Itemscreate') }}">  {{trans('transfile.library_create_item')}}</a></li>
                        <li><a class="slide-item" href="{{ url('/' . $page='item_version') }}">   {{trans('transfile.library_itemversion')}}</a></li>
             ...
             <li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">{{trans('transfile.loan_mangment')}}</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">


                        <li><a class="slide-item" href="{{ url('/' . $page='member_loan') }}">  {{trans('transfile.library_create_new_loan')}}</a></li>
                        <li><a class="slide-item" href="{{ url('/' . $page='item_version') }}">   {{trans('transfile.library_itemversion')}}</a></li>
                    ...
                    <li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M3.31 11l2.2 8.01L18.5 19l2.2-8H3.31zM12 17c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z" opacity=".3"/><path d="M22 9h-4.79l-4.38-6.56c-.19-.28-.51-.42-.83-.42s-.64.14-.83.43L6.79 9H2c-.55 0-1 .45-1 1 0 .09.01.18.04.27l2.54 9.27c.23.84 1 1.46 1.92 1.46h13c.92 0 1.69-.62 1.93-1.46l2.54-9.27L23 10c0-.55-.45-1-1-1zM12 4.8L14.8 9H9.2L12 4.8zM18.5 19l-12.99.01L3.31 11H20.7l-2.2 8zM12 13c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"/></svg><span class="side-menu__label">جميع العناصر </span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='items_show') }}">المنتجات الالكترونية</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='items_single-details') }}">تفاصيل المنتج</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='items_show-cart') }}">Cart</a></li>
						</ul>
					</li>
...
<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">{{trans('transfile.users' )}}</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='users') }}">{{trans('transfile.add_users')}}</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='all_payments') }}">payments</a></li>

						</ul>
</li>
<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg>
						<span class="side-menu__label">الاعدادت</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='discount_roles') }}">قواعد نسب الخصم</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='finance_degree') }}">الدرجات المالية </a></li>
