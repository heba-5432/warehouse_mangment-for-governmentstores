					...
					<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
						<div class="card  box-shadow-0">
							<div class="card-header">
								...
								<p class="mb-2">ادخل معلومات المستخدمين</p></h4>
							</div>
...
@endif
								...
								@method('POST')
									...
									<div class="form-group">
										<input type="password" class="form-control" id="inputPassword3" name ="password_confirmed" placeholder="Password_confirm">
									</div>
									<div class="form-group">
										<input type="text" class="form-control" id="inputName" name ="role_id" placeholder="role">
									</div>
									<div class="form-group">
										<input type="text" class="form-control" id="inputName" name ="depar_id" placeholder="department">
									</div>
									<!-- col-4 -select start--->
...
<td></td>
												...
												<td width="10%">
													...
													<a class="btn ripple btn-primary" data-target="#mo" data-toggle="modal" href="">edit</a>
...
<div class="modal-content modal-content-demo">
 ...
 <!-- Basic modal -delete button--start--->
  <a class="btn ripple btn-primary" data-target="#mod" data-toggle="modal" href="">delete</a>
