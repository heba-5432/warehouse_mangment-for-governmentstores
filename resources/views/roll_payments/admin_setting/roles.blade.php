					...
					<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
						<div class="card  box-shadow-0">
							<div class="card-header">
								...
								<figure class="mb-2">{{trans('transfile.role_level')}}</figure>
							</div>
...
@endif
								...
								@method('POST')
                                    ...
                                    <input type="text" class="form-control" id="inputName"  name ="role_title" placeholder="tile">
<br>
                                    <input type="text" class="form-control" id="inputName"  name ="role_description" placeholder="description">
									</di>
...
$i=0;
@endphp
												<th class="thead-dark" width="5%">no</th>
 ...
 @foreach ($roles as $rol_data )
											...
											<tr>
											<td>{{$i=$i+1}}</td>
												<td width="5%" >{{$rol_data->role_title}}</td>
                                                   <td >{{$rol_data->role_description}}</td>
<!----
												<td width="10%">
													<!-- Basic modal -edit button--start
													<a class="btn ripple btn-primary" data-target="#mo{{$rol_data->id}}" data-toggle="modal" href="{{$rol_data->id}}">edit</a>

<!-- Basic modal -edit alert--start
<div class="modal" id="mo{{$rol_data->id}}">
			<div class="modal-dialog" role="document">
				<div class="modal-content modal-content-demo">
					...
					<div class="modal-body">
						...
						<form class="form-horizontal"  method="POST" action="{{route('roles.edit',$rol_data->id)}}">

					@csrf
								@method('POST')
									<div class="form-group">
										<input type="text" class="form-control" id="inputName"  name ="role_title" placeholder="Name" value="{{$rol_data->role_title}} ">
                                        <input type="text" class="form-control" id="inputName"  name ="role_description" placeholder="Name" value="{{$rol_data->role_description}} ">
 ...
 <!-- Basic modal -delete button--start
  <a class="btn ripple btn-primary" data-target="#mod{{$rol_data->id}}" data-toggle="modal" href="{{$rol_data->id}}">delete</a>
					<!-- Basic modal -delete button--end--->
<!-- Basic modal -delete alert--start--->
<!--div class="modal" id="mod{{$rol_data->id}}">
			<div class="modal-dialog" role="document">
				<div class="modal-content modal-content-demo">
					<div class="modal-header">
					...
					<div class="modal-footer">
						<a href="{{route('role.destroy',$rol_data->id)}}"><button class="btn ripple btn-primary" type="button">confirm delete</button></a>
						<button class="btn ripple btn-secondary" data-dismiss="modal" type="button">cancel</button>
					</div>
				</div>
			</div>
