...
@endif
                                ...
                                <div class="col-lg-6 col-xl-6 col-md-6 col-sm-12" style="float:right">
									...
									<div class="form-group">
										<input type="password" class="form-control" id="inputPassword3" name ="password_confirmed" placeholder="password_confirmed">
									</div>
                                    </div>
...
<div class="col-lg-6 mg-t-20 mg-lg-t-0">
                                        ...
                                        <select class="form-control select2" name="position_id" >
											...
											<option disabled selected>--اختار الدرجه الماليه--</option>
                                    @foreach ($fin_d as $fin1_info )
                                    <option value="{{$fin1_info->id}}">{{$fin1_info->fin_title}}</option>
                                    @endforeach
                                    ...
                                    <!-- col-4 select end-->
                                    <div class="form-group">
										<input type="text" class="form-control" id="inputName" name ="national_id" placeholder="national_id" value="{{old('national_id')}}">
									</div>

									<div class="form-group">
										<input type="text" class="form-control" id="inputName" name ="depar_id" placeholder="department" value="{{old('depar_id')}}">
									</div>
									<div class="form-group">
                                        @if(!empty($roles_info))
										<fieldset>
...
<div class="col-lg-6 mg-t-20 mg-lg-t-0">
                                    ...
                                    <option value="{{$rol_info ->id}}">{{$rol_info->role_title}}</option>
                                    @endforeach
