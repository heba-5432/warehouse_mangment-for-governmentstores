...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					...
					<div class="d-flex my-xl-auto right-content">
                        ...
                        <a href="{{route('emailslogs')}}"><button class="btn btn-primary" style="float:left">show emails logs</button></a>
...
@endif
								...
								<form class="form-horizontal"  method="POST" action="{{route('all_payments.ser')}}">
								@csrf
								@method('POST')
...
<div class="card-header">
								<h2 class="card-title mb-1">
								<p class="mb-2">email information</p></h2>
							</div>
...
<div class="form-group col-lg-12 mg-t-20 mg-lg-t-0" >
                                        ...
                                        <label>start date</label>
										<input type="date" class="form-contro col-lg-4 mg-t-20 mg-lg-t-0" id="inputName"  name ="start_date1" placeholder="start date" value="{{old('start_date1')}}">

                                        <label>end date</label>
										<input type="date" class="form-contro col-lg-4 mg-t-20 mg-lg-t-0" id="inputName"  name ="end_date1" placeholder="start date" value="{{old('end_date1')}}">
...
<select class="form-control select2" name="user_id2" >

    <option disabled selected>--choose from panel--</option>

@foreach ($user_info1 as $user_in2)
@if(!empty($user_in2))
<option value="{{$user_in2->id}}">{{$user_in2->name}}</option>
@endif
@endforeach
