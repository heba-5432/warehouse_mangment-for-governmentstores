					...
					<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
						<div class="card  box-shadow-0">
							<div class="card-header">
								...
								<p class="mb-2">{{trans('transfile.library_system')}}</p>
...
<label>books</label>
<select class=" select2 col-lg-4 mg-t-20 mg-lg-t-0 " multiple="multiple"name="keyword_ida[]">

<option disabled >--choose catogery from panel--</option>
@if(!empty($all_items))
@foreach ($all_items as $iteall)
<option value="{{$iteall->id}}"


>{{$iteall->title_ara}}</option>
@endforeach
@endif
</select>
...
<!-- col-4 -select start--->
    ...
    <label  style ="margin:2px; padding:2px;">books version</label>
    <select class=" select2 col-lg-4 mg-t-20 mg-lg-t-0 " multiple="multiple"name="keyword_ida[]">

<option disabled >--choose catogery from panel--</option>
@if(!empty($all_items))
@foreach ($all_items as $iteall)
<option value="{{$iteall->iver_id}}"


>{{$iteall->title_arav}}</option>
@endforeach
@endif
